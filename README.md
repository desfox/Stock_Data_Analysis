...
<img src="https://user-images.githubusercontent.com/56491233/236254859-4b3c9178-ac6c-4081-94ee-8beb680b80ea.gif">

| Features

- 정보데이터시스템(http://data.krx.co.kr/) 의 "종목정보 > 전종목 기본정보"를 크롤링한 데이터를 페이지네이션으로 구분해 메인페이지에 출력
- 종목명과 기간을 입력한 뒤 보고싶은 차트 유형을 선택하면, 이에 해당하는 차트 정보를 메인페이지에 출력
  <br>
  (현재 적재된 데이터로는 "삼성전자"와 "LG전자"의 차트만 열람 가능)
